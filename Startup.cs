  ...
  public class Startup
  {
    ...
    private void PrepareDB()
    {
      ...
      using (var connection = new SqliteConnection(connectionStringBuilder.ConnectionString))
      {
        ...
        createTableCmd.CommandText = "CREATE TABLE Employees (Id INTEGER,Name VARCHAR(50),Value INT, Department INTEGER, Photo VARCHAR(50), PRIMARY KEY(Id AUTOINCREMENT), FOREIGN KEY(Department) REFERENCES Departments(id))";
